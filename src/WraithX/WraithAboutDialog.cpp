...
BEGIN_MESSAGE_MAP(WraithAboutDialog, WraithWindow)
	...
	ON_COMMAND((int32_t)WraithAboutDialogID::DonateControl, OnDonateClick)
END_MESSAGE_MAP()
...
void WraithAboutDialog::OnBeforeLoad()
{
	...
	SetControlAnchor((int32_t)WraithAboutDialogID::DonateControl, 0, 100, 0, 0);
...
void WraithAboutDialog::OnDonateClick()
{
	// Open the donate url
	ShellExecuteA(NULL, "open", "http://aviacreations.com/modme/index.php?view=donate", NULL, NULL, SW_SHOWNORMAL);
}
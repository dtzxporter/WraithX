...
void WraithTheme::InitializeDefaultTheme()
{
	...
	DefaultControlBorder = Gdiplus::Color(255, 50, 205, 50);	// LIMEGREEN
	...
	DefaultFillGradTop = Gdiplus::Color(255, 50, 205, 50);		// GRADIENT COLOR TOP
	DefaultFillGradBottom = Gdiplus::Color(255, 34, 139, 34);	// GRADIENT COLOR BOTTOM
	...
	// Add hints
	ColorHints.push_back(Gdiplus::Color(255, 50, 205, 50));		// LIMEGREEN (0)
	ColorHints.push_back(Gdiplus::Color(255, 255, 0, 0));		// RED (1)
	ColorHints.push_back(Gdiplus::Color(255, 30, 144, 255));	// DODGERBLUE (2)
